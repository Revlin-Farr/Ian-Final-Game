class Loss extends Phaser.Scene {
    ...
    create(){
      ...
      let lossConfig = {
        ...
        this.add.text(game.config.width/2, game.config.height/1.75 + borderUISize + borderPadding, 'Remember avoid the GRABING HANDS but collect the TASTY CHEESE!', lossConfig).setOrigin(0.5);
